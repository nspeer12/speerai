      ...
      updateObj: function updateObj(obj, d) {
        ...
        if (Object.keys(targetD).some(function (k) {
          ...
          if (!state.heatmapsTransitionDuration || state.heatmapsTransitionDuration < 0) {
            ...
            // animate
            new TWEEN.Tween(currentTargetD).to(targetD, state.heatmapsTransitionDuration).easing(TWEEN.Easing.Quadratic.InOut).onUpdate(applyUpdate).start();
          }
        }
      }
    });
    ...
    threeDigest(state.htmlElementsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        if (!state.htmlTransitionDuration || state.htmlTransitionDuration < 0 || !obj.__currentTargetD) {
          ...
          // animate
          new TWEEN.Tween(obj.__currentTargetD).to(targetD, state.htmlTransitionDuration).easing(TWEEN.Easing.Quadratic.InOut).onUpdate(applyUpdate).start();
        }
      }
    });
  }
    ...
    var initGlobe = function initGlobe() {
      if (animateIn) {
        ...
        new TWEEN.Tween({
          ...
          k: 1
        }, 600).easing(TWEEN.Easing.Quadratic.Out).onUpdate(function (_ref17) {
          var k = _ref17.k;
        ...
        new TWEEN.Tween({
          ...
          rot: 0
        }, 1200).easing(TWEEN.Easing.Quintic.Out).onUpdate(function (_ref18) {
          var rot = _ref18.rot;
